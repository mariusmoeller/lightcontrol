function timer() {
    ...
    + '<input class="knob hour" data-readOnly="true" data-width="150" data-min="0" data-max="24" data-displayPrevious=true data-fgColor="#66EE66" data-skin="tron" data-thickness=".2" value="75">' 
    ...
    $('.countdownControl').click(function (event) {
        ...
        if (text === "Start") {
            ...
            $(".ccounter").ccountdown(2014, 5, 16, '13:00'); //only need to pass target date and time
            $(".countdownControl").text("Stop");
        } else if (text === "Stop") {
            $(".ccounter").remove();
            $('.container').show();
        }
